...
public class Account{
    ...
    /**
     * This method checks the given post commented or not
     * @param post Post variable to be checked for comment
     * @return boolean variable to represent commented or not.
     */
     ...
     * @param account Account variable to be followed
     * @return ArrayList's contains method
     */
